...
public class Client implements Runnable {
	...
	private static JPanel initOptionsPane() {
		...
		if (featureConfiguration.color) {
			gridSize++;
		}
		if (featureConfiguration.authentication) {
			gridSize++;
		}
...
//                  appendToChatBox("OUTGOING: " + s + "\n");
					...
					if (featureConfiguration.encryption) {
		...
		while (true) {
			...
			case BEGIN_CONNECT:
				try {
					...
					// Send password
					if (featureConfiguration.authentication && passwordField != null) {
